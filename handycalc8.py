...
#ver 8 스크린샷, z키 비활성, 실험적 11분 종료
#ver 8.1 항복위치 좀더 가운데로
#ver 8.2 대기시간 12분으로 늘림
#ver 8.3 게임진입 실패했을때 챔피언픽하는 클릭이 작업표시줄의 어플들을 실행시키는 문제점이 있었는데 예전에 수정했으나 그것으론 부족하여 더 수정함
...
#항복
    ...
    pag.moveTo(random.uniform(680+2,833-2),random.uniform(854+2,888-2),random.uniform(0.4,2))
    pag.mouseDown()
