...
load_profile1_img = np.array(load_profile1_capture)
load_profile2_img = np.array(load_profile2_capture)
load_profile3_img = np.array(load_profile3_capture)
load_profile4_img = np.array(load_profile4_capture)
load_profile5_img = np.array(load_profile5_capture)
load_profile6_img = np.array(load_profile6_capture)
load_profile7_img = np.array(load_profile7_capture)
load_profile8_img = np.array(load_profile8_capture)

load_profile1 = cv2.cvtColor(load_profile1_img, cv2.COLOR_RGB2GRAY)
load_profile2 = cv2.cvtColor(load_profile2_img, cv2.COLOR_RGB2GRAY)
load_profile3 = cv2.cvtColor(load_profile3_img, cv2.COLOR_RGB2GRAY)
load_profile4 = cv2.cvtColor(load_profile4_img, cv2.COLOR_RGB2GRAY)
load_profile5 = cv2.cvtColor(load_profile5_img, cv2.COLOR_RGB2GRAY)
load_profile6 = cv2.cvtColor(load_profile6_img, cv2.COLOR_RGB2GRAY)
load_profile7 = cv2.cvtColor(load_profile7_img, cv2.COLOR_RGB2GRAY)
load_profile8 = cv2.cvtColor(load_profile8_img, cv2.COLOR_RGB2GRAY)
