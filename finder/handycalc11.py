...
def loadingFinder():
    try:
        location = pag.locateCenterOnScreen( r'C:\Users\Qone\GoogleDrive\programming\python\handycalc\finder\loadingRock.png')
    except TypeError:
        location = (0, 0)
...
def startFinder():
    try:
        location = pag.locateCenterOnScreen(
            r'C:\Users\Qone\GoogleDrive\programming\python\handycalc\finder\start.png')
    except TypeError:
        location = (0, 0)
...
def regameFinder():
    try:
        location = pag.locateCenterOnScreen(
            r'C:\Users\Qone\GoogleDrive\programming\python\handycalc\finder\button7.png')
    except TypeError:
        location = (0, 0)
